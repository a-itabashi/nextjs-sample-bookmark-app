          ...
          <div className='mx-auto max-w-3xl'>
            ...
            <div className='flexjustify-center mt-5'>
              <div className='mt-3'>
                <Link
                  href='/articles'
                  className='group inline-flex items-center justify-center overflow-hidden rounded-lg bg-gradient-to-br
                 from-purple-600 to-blue-500 p-0.5 font-medium text-gray-900 hover:text-white focus:ring-4 focus:ring-blue-300
